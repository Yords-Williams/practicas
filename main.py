...
from modulos.choques.detector import AccidentDetectionSystem
...
def main():
    """Iniciar la aplicación Alertas Tempranas optimizada para Quadro P1000"""
    
    print("\n" + "="*70)
    print("Alertas Tempranas - SISTEMA OPTIMIZADO")
    ...
    print("[MAIN] ✓ Sistema Alertas Tempranas iniciado")
