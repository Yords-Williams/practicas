...
class AccidentDetectionSystem:
    def __init__(self, yolo_model_path="best.pt", damage_model_path="detector_de_auto_con_dano.pt", video_source=0):
        """Inicializar el sistema de detección de accidentes"""
