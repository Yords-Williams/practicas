...
def validate_all():
    ...
    print("\n" + "╔" + "="*68 + "╗")
    print("║" + "CCTV AI PRO - VALIDATION REPORT".center(68) + "║")
    ...
    accident_model = os.path.join("modulos", "best.pt")
    ...
    models_ok = yolo_exists and accident_exists and damage_exists
    all_ok = all_ok and models_ok
    
    # 7. Modules
    print_section("7. SPECIALIZED MODULES")
    
    accident_module = os.path.join("modulos", "accident_detection.py")
    accident_mod_exists = os.path.exists(accident_module)
    print(f"{check_mark(accident_mod_exists)} accident_detection.py")
    ...
    robo_module = os.path.join("modulos", "robo_detector.py")
    robo_mod_exists = os.path.exists(robo_module)
    print(f"{check_mark(robo_mod_exists)} robo_detector.py")
    
    modules_ok = accident_mod_exists and person_mod_exists and robo_mod_exists
    ...
    if all_ok:
        print("\n✓✓✓ ALL CHECKS PASSED ✓✓✓")
        print("\nYour system is ready to run CCTV AI PRO with optimal performance!")
        print("\nNext steps:")
